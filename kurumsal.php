...
<html lang="tr">
  <head>
      ...
      <title>Kurumsal - Akdoğan Rent A Car</title>
      ...
      <div class="section-title-page area-bg area-bg_dark area-bg_op_60">
        <div class="area-bg__inner">
          <div class="container text-center">
            <h1 class="b-title-page">Kurumsal</h1>
             ...
             <div class="container">
              <div class="row">
                <div class="col-md-10 offset-md-1 text-center pt-4 mb-5">
                  <div class="ui-title-logo">KURUMSAL</div>
                  <h2 class="ui-title mb-4">Akdoğan Rent A Car</h2>
                  <p><?=$db->ayarlar("value" , "hakkimizda");?></p>
