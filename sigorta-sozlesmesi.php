...
<html lang="tr">
  <head>
      ...
      <title>Sigorta Sözleşmesi - Akdoğan Rent A Car</title>
      ...
      <div class="section-title-page area-bg area-bg_dark area-bg_op_60">
        <div class="area-bg__inner">
          <div class="container text-center">
            <h1 class="b-title-page">Sigorta Sözleşmesi</h1>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index">Anasayfa</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sigorta Sözleşmesi</li>
              </ol>
            </nav>
            <!-- end .breadcrumb-->
             ...
             <div class="container">
              <div class="row">
                <div class="col-md-10 offset-md-1 text-center pt-4 mb-5">
                  ...
                  <h2 class="ui-title mb-4">Sigorta Sözleşmesi</h2>
                  <p><?=$db->ayarlar("value" , "sigorta");?></p>
